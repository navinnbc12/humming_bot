...
from . import exchangeforest_perpetual_utils


class ExchangeforestPerpetualOrderBook(OrderBook):
    _bpob_logger = None
    ...
    def diff_message_from_exchange(cls, msg: Dict[str, any], timestamp: Optional[float] = None,
        ...
        return OrderBookMessage(OrderBookMessageType.DIFF, {
            "trading_pair": exchangeforest_perpetual_utils.convert_from_exchange_trading_pair(data["s"]),
            "update_id": data["u"],
            "bids": data["b"],
            "asks": data["a"]
        }, timestamp=timestamp)
