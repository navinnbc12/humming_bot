...
from hummingbot.connector.derivative.exchangeforest_perpetual.exchangeforest_perpetual_api_order_book_data_source import \
    ExchangeforestPerpetualAPIOrderBookDataSource


class ExchangeforestPerpetualOrderBookTracker(OrderBookTracker):
    ...
    def data_source(self) -> OrderBookTrackerDataSource:
        if not self._data_source:
            if self._data_source_type is OrderBookTrackerDataSourceType.REMOTE_API:
                ...
                self._data_source = ExchangeforestPerpetualAPIOrderBookDataSource(trading_pairs=self._trading_pairs)
            else:
